...
def main():
    ...
    for i, data in enumerate(data_loader):
        ...
        cv2.imwrite(f'output_result/pv/pv_{i}.jpg', cams_img,[cv2.IMWRITE_JPEG_QUALITY, 70])
        ...
        for vis_format in args.gt_format:
            if vis_format == 'se_pts':
                ...
                plt.savefig(f'output_result/gt/gt_{i}.png', bbox_inches='tight', format='png',dpi=1200)
                plt.cla()
                plt.clf()
                plt.close("all")   
        ...
        # import ipdb;ipdb.set_trace()
        #10 
        # [ 8, 32, 16, 23, 48,  4, 29, 27, 40,]
        #20
        # [23, 24, 21, 17, 30, 32, 41,
        #30
        # [41,  1, 23, 27, 30, 38,  9, 40, 24,  7,
        #40
        # [17, 43, 28,  9, 49, 13,  3, 10
        #50
        # [21, 32, 11
        plt.figure(figsize=(2, 4))
        plt.xlim(pc_range[0], pc_range[3])
        ...
        plt.savefig(f'output_result/pred/pred_{i}.png', bbox_inches='tight', format='png',dpi=1200)
        plt.cla()
        plt.clf()
        plt.close("all")
