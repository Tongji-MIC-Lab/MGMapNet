...
class MapTRv2(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, gt_seg_mask, gt_ins_seg_mask, gt_pv_seg_mask, outs]
        ...
        loss_one2many_inputs = [multi_gt_bboxes_3d, multi_gt_labels_3d, gt_seg_mask,gt_ins_seg_mask, gt_pv_seg_mask, one2many_outs]
    ...
    def forward_train(self,
        ...
        losses_pts = self.forward_pts_train(img_feats, lidar_feat, gt_bboxes_3d,
                                            ...
                                            gt_bboxes_ignore, prev_bev, gt_depth,gt_seg_mask,gt_ins_seg_mask,gt_pv_seg_mask)
